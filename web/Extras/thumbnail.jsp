<%-- 
    Document   : thumbnail
    Created on : 02-Jul-2021, 6:01:30 PM
    Author     : MARCOS
--%>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
		...
		<!-- upload -->
		<form method="post" ACTION="thumbnail_process.jsp?vcode=<%=vcode%>" name="uploadForm" ENCTYPE='multipart/form-data'>
                    <table align="center" width="50%" height="25%" style="margin:10%;">
<tbody>
<tr>
<th>File Upload:</th>
