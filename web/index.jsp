...
<%
    ...
    try {
        ...
        if (email != null && session.getAttribute(email) != null) {
            ...
            ResultSet getChannel = st.executeQuery("select chcode from channel where usercode='" + dp_name + "'");
            if (getChannel.next()) {
                chCode = getChannel.getString(1);
                hasChannel = true;
...
<html>
    ...
    <body>
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <div class="top-search">
                        <form class="navbar-form navbar-right">
                            <input id="top-search" type="text" class="form-control" placeholder="Search...">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="top-slide">
                <button id="slideLeft" class="slide-button left"><span class="material-icons">arrow_back_ios</span></button>
                <button id="slideRight" class="slide-button right"><span class="material-icons">arrow_forward_ios</span></button>
                <div class="top-category-div" id="top-category">


                    <button class="top-category category-active" id="All" onclick="selectCategory(this.id)">All</button>
                    <button class="top-category" id="Trailers" onclick="selectCategory(this.id)">Trailers</button>
                    <button class="top-category" id="Cricket" onclick="selectCategory(this.id)">Cricket</button>

                    <button class="top-category" id="Songs" onclick="selectCategory(this.id)">Songs</button>
                    <button class="top-category" id="Party-Songs" onclick="selectCategory(this.id)">Party-Songs</button>
                    <button class="top-category" id="Comedy" onclick="selectCategory(this.id)">Comedy</button>

                    <button class="top-category" id="Educational" onclick="selectCategory(this.id)">Educational</button>

                    <button class="top-category" id="Gaming" onclick="selectCategory(this.id)">Gaming</button>
                    <button class="top-category" id="Vlogs" onclick="selectCategory(this.id)">Vlogs</button>


                    <button class="top-category" id="Programming" onclick="selectCategory(this.id)">Programming</button>
                    <button class="top-category" id="Tennis" onclick="selectCategory(this.id)">Tennis</button>
                    <button class="top-category" id="Motivational" onclick="selectCategory(this.id)">Motivational</button>
                    ...
                    <div class="recommended-grids">
                        ...
                        <div  id="top" class="callbacks_container">
                            <ul class="rslides" id="slider3">
                                <li>
                                    <div id="video-display" class="animated-grids">
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("#top-search").keyup(function () {
                        var rec = $(this).val();
                        console.log(rec);
                        $.post("search.jsp", {search: rec}, function (data) {
                            $("#video-display").html(data);

                        });

                    });
                    $(document).on("mouseenter", ".image-class", function () {
                        $(this).get(0).play();

                    });
                    $(document).on("mouseout", ".image-class", function () {
                        $(this).get(0).load();
                    ...
                    buttonRight.onclick = function () {
                        document.getElementById('top-category').scrollLeft += 60;
                    };
                ...
                function selectCategory(val) {
                    categoryValue = val;
                    $(".top-category").removeClass("category-active");
                    $("#" + val).addClass("category-active");
                    $("#category-heading").text(val);
                    $.post("index_process.jsp", {category: val, getresult: 0}, function (data) {
                        console.log(data);
                        $("#video-display").html(data);
                ...
                function loadmore()
                {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            var content = document.getElementById("video-display");
